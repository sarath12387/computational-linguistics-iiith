...
function correcttoggle() {
  ...
  res.innerHTML =
    "<center><font color = 'red'>Wrong Answer!!!</font><br><button id='showansbtn' onclick='hide()'>Hide correct sentence</button></center>";
}
function hide() {
  res.innerHTML =
    "<center><font color = 'red'>Wrong Answer!!!</font><br><button id='showansbtn' onclick='correcttoggle()'>Get answers</button></center>";
...
function getcorrect() {
  ...
  if (x == 'english') {
    totalanswers = English[r].length - 1;
    res.innerHTML =
      "<center><font color = 'red'>Wrong Answer!!!</font><br><button id='showansbtn' onclick='hide()'>Hide correct sentence</button></center>";
...
function correctioncheck() {
  ...
  correctanswers.innerHTML = '';
  //answers="";
  if (x == 'english') result = English[r].includes(fs);
  else if (x == 'hindi') result = Hindi[r].includes(fs);
...
function Formsent(id, value) {
  ...
  reform.innerHTML =
    "<center><button id='refornbtn' onclick='Reformsent()'>Re-form the sentence</button></center>";
  clickcount++;
  ...
  if (x == 'english') {
    ...
    for (i = 0; i <= j.length - 1; i++) {
      ...
      b =
        "  <button id='btn" +
        i +
        "'onclick='Formsent(this.id,this.value)' value='" +
        val +
        "'>" +
        val +
        '</button>  ';
...
function experimentshow() {
  ...
  select.innerHTML =
    "<select id='lang' onchange = 'dropdown()'><option value='select'>---Select Language---</option><option value='english'>English</option><option value='hindi'>Hindi</option></select>";
  seldesc.innerHTML = '';
  desc3.innerHTML = '';
  desc.innerHTML = '';
  desc2.innerHTML = '';
